 ...
 * </pre>
 */
class RfHardwareKeyGattService : Service() {
    ...
    override fun onCreate() {
        ...
        val notificationChannel = NotificationChannel(
            RfHardwareKeyGattService::class.java.simpleName,
            resources.getString(R.string.rf_hardware_key_gatt_service_name),
        ...
        val notification = NotificationCompat.Builder(this, RfHardwareKeyGattService::class.java.simpleName)
            .setSmallIcon(R.mipmap.ic_launcher)
            .setContentTitle(resources.getString(R.string.rf_hardware_key_gatt_service_name))
            .setContentText(resources.getString(R.string.rf_hardware_key_gatt_service_running_notification))
            .setAutoCancel(true)
    ...
    private inner class ClientManager : BleManager(this@RfHardwareKeyGattService) {
